...
int main(int argc, char *argv[]) {
  ...
  sendall(socketFD, &plaintextLength, sizeof(plaintextLength));
  ...
  char ciphertextBuffer[plaintextLength + 1];
  memset(ciphertextBuffer, '\0', sizeof(ciphertextBuffer));
  recv(socketFD, ciphertextBuffer, sizeof(ciphertextBuffer) - 1, 0);
  printf("%s\n", ciphertextBuffer);
